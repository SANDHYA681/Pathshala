import json
from collections import defaultdict  # ✅ Required for click and unique count tracking
...
def dashboard(request):
    ...
    for b in blogstats:
        ...
        unique_data[date_str] += b.unique_views   # ✅ Fixed from data_str to date_str
    ...
    return render(
        request,
        'pages/dashboard/writer/dashboard.html',
        {
            "blog_clicks": json.dumps(blog_clicks),
            "click_date": json.dumps(click_date),
            "unique_views": json.dumps(unique_views)
        }
    )
